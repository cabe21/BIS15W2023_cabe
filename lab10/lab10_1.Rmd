...
```{r}
#options(scipen=999)cancels scientific notation for the session (removes the multiply by 10 raised to the power of whatever)
```
...
```{r}
elephants%>% 
  ggplot(mapping=aes(x=sex, y=age))+geom_boxplot()
```
