...
1. What is a vector in R?  
  A vector is a series of objects that are attached to a certain name. The objects that are being attatched can be numeric, characteristics, etc. 

2. What is a data matrix in R?  
A data matrix in R is when  you have multiple vectors complied into rows and columns to form something that looks like a data table. 
