...
A vector is a series of things (numeric, characteristics, etc.) that are attached to a certain object. 

2. What is a data matrix in R?  
A data matrix in R is where you have multiple vectors complied into rows and columns to form something that looks like a data table. 
