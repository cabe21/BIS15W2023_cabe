...
They are using money as a bunch of treatments when the income should be the treatment and the money should be the data
...
The days are not individual treatments and need to be put into one column. 
